...
def test_custom_feature(page):
    ...
    """
    # 1. 初始化 AI 驱动与引擎
    # 推荐使用 gpt-4o 等强力多模态模型，通过 use_vision=True 开启“截图+DOM”双重分析能力
    driver = PlaywrightDriver(page)
    agent = AITesterAgent(driver, model_name="gpt-4o", use_vision=True)
